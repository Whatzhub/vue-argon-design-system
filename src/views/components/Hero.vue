            ...
            <div class="col px-0">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-7 text-center pt-lg">
                        <img src="img/brand/decentral-logo-white.png" style="width: 350px;" class="img-fluid">
                        <p class="lead text-white mt-1 mb-5">A all-in-one decentralised protocol bank. Trust in the system.</p>
                ...
                <div class="row align-items-center justify-content-around stars-and-coded">
                    ...
                    <div class="col-sm-4 mt-4 mt-sm-0 text-right">
                        <span class="text-white alpha-7">Created by DeFi Bankers with <i class="fa fa-heart"></i></span>
